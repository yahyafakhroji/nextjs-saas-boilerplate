    ...
    <div className="flex flex-col items-center text-center">
      ...
      <div className="mt-6 flex w-full items-center justify-between gap-y-2 border-t pt-3 text-sm text-muted-foreground max-md:flex-col">
        <div>
          ...
          {t.rich("designed_by", {
            author: () => (
              <a className="text-blue-500 hover:text-blue-600" href="https://creativedesignsguru.com">
        ...
        <ul className="flex gap-x-4 font-medium [&_a:hover]:opacity-100 [&_a]:opacity-60">{props.legalLinks}</ul>
      </div>
    </div>
  );
};
